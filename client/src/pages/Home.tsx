export const Home = () => {
  return (
    <div className={'px-4 py-12 max-w-2xl mx-auto'}>
      <h1 className={'text-3xl font-bold mb-4 text-slate-800'}>Welcome my Auth App!</h1>
      <p className="mb-4 text-slate-700">
        ...
        log in, and log out, and provides access to protected routes only for
        authenticated users.
      </p>
      <p className="mb-4 text-slate-700">
        ...
        MongoDB as the database. Authentication is implemented using JSON Web Tokens
        (JWT).
      </p>
      <p className="mb-4 text-slate-700">
